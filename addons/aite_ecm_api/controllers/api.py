...
def api_route(*urls, methods=('GET',)):
    ...
    def decorator(func):
        # ``readonly=False`` : l'authentification par clé d'API écrit
        # (dernière utilisation de la clé), et les routes POST créent des
        # versions — cf. commentaire du contrôleur WebDAV.
