...
| --- | --- | --- | --- |
| **Tests unitaires et d'intégration** | règles métier, droits, calculs, contrôleurs HTTP | tests Odoo (`--test-enable`) | **322 tests**, 25 modules |
...
| `aite_courrier_webdav` | 34 | service WebDAV du courrier et **son contrôleur HTTP** (11 verbes, Basic, multistatus, codes de statut), contrôle d'accès |
