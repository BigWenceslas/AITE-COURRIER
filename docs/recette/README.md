...
| `verif_audit_refus.py` | Contrôle de bout en bout, sur un serveur démarré : une transition refusée reste tracée au journal d'audit malgré l'annulation de la requête |
